...
<body id="page-top">
		...
		<div class="container">
			...
			<div>
			    <a href="category-form.jsp">
					<button class="btn btn-primary btn-xl mb-3" id="submitButton"
							type="submit" style="margin-left: 1.5rem;">Create Category</button>
				</a>
			</div>
	...
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Clients</h2>
			<!-- Icon Divider-->
			<div class="divider-custom">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
	...
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
	<div class="portfolio-modal modal fade" style="margin-top: 60px;" id="portfolioModal1" tabindex="-1" aria-labelledby="portfolioModal1" aria-hidden="true">
