...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Books Wander<span class="admin-text">Admin</span>	 </a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#categories">Categories</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="ListAccountsServlet">Clients</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<!-- to get an API token!-->
					<form id="contactForm" action="AddCategoryServlet" method="post" enctype="multipart/form-data" data-sb-form-api-token="API_TOKEN">
						<!-- Name input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="category_name" name="category_name" type="text"
								placeholder="Enter the book name" data-sb-validations="required" />
							<label for="category_name">Category name</label>
							<div class="invalid-feedback" data-sb-feedback="category_name:required">A
								title is required.</div>
						</div>
						<div class="form-floating mb-3">
							<textarea class="form-control" id="description" name="description" type="text"
								placeholder="Enter your description here..." style="height: 10rem"
								data-sb-validations="required"></textarea>
							<label for="description">Description</label>
							<div class="invalid-feedback" data-sb-feedback="description:required">A
								message is required.</div>
						</div>
						<input type="file" id="real-file" hidden="hidden" name="cat_image"/>
						<button type="button" class="btn btn-primary btn-xl mb-3 px-2 py-2" id="custom-button">Choose an image</button>
						...
						<button type="submit" class="btn salem btn-primary btn-xl mb-3">CREATE</button>
