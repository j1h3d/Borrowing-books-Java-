      ...
      <div class="input-group mt-4">
		 <div class="form-outline w-100" data-mdb-input-init>
			<form action="search" method="get">
				<input placeholder="Search Books" type="search" name="search" class="form-control p-4" />
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0 mt-4">Catalogue</h2>
			...
			<%for (Bien bien : biens) { %>
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						data-bs-target="#portfolioModal<%= bien.getId()%>">
						<div
						...
						<img class="img-fluid" src="<%= bien.getImage()%>"
							alt="..." />
						</div>
						<p class="page-section-heading fs-1 text-center text-secondary mb-0 mt-2"><%= bien.getTitle()%></p>
												
				</div>
				
				
				<div class="portfolio-modal modal fade" id="portfolioModal<%= bien.getId()%>" tabindex="-1" aria-labelledby="portfolioModal1" aria-hidden="true" style="margin-top: 20px;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header border-0">
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Adjusted modal-body with increased padding -->
            <div class="modal-body pb-5 pt-4">
                <div class="container">
                    <div class="row">
                        <!-- Image Section (Left Side) -->
                        <div class="col-lg-6">
                            <img class="img-fluid rounded mb-5" src="<%= bien.getImage()%>" alt="..." />
                        </div>
                        <!-- Text Section (Right Side) -->
                        <div class="col-lg-6">
                            <div class="text-center">
                                <!-- Title -->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"><%= bien.getTitle()%></h2>
                                <!-- Icon Divider -->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon">
                                ...
                                <!-- Text -->
                                <p class="mb-4"><%= bien.getDescription()%></p>
                                <p class="mb-4 font-monospace">Price per day: <%= bien.getPrice_per_day()%></p>
                                <!-- Date Inputs -->
                                <form action="addReservation" method="get">
                                <label for="start-date" class="labeel">Start Date:</label>
                                <input type="date" id="start-date" class="inbout" name="start_rent" required>
                                <br>
                                <label for="end-date" class="labeel">End Date:</label>-
                                <input class="inbout" type="date" id="end-date" name="end_rent" required>
	        					<input type="hidden" name="id_user" value="<%= session.getAttribute("userId") %>">
	        					<input type="hidden" name="id_bien" value="<%= bien.getId() %>">
	        					<input type="hidden" name="price_per_day" value="<%= bien.getPrice_per_day() %>">
                                <br>
                                <% if(bien.getDisponibility().equals("Available")){ %>
                                <!-- Book Button -->
                                <button class="btn btn-primary" >
                                    Book the book
                                </button>
                                <% }else{ %>
                                <button class="btn btn-primary" disabled data-bs-dismiss="modal">
                                    Unavailable
                                </button>
                                <% } %>
                                </form>
