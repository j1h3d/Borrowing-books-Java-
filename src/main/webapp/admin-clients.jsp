...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="admin-home.jsp">Categories</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#clients">Clients</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<section class="page-section" id="clients">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0 mt-4">Clients</h2>
			<!-- Icon Divider-->
			...
			<c:choose><c:when test="${accounts.size() >= 1}">
  ...
  <tbody>
	<c:forEach var="user" items="${accounts}">
                    ...
                    <td class="bg-danger text-center">
  						<a href="DeleteAccountServlet?id=<c:out value='${user.id}' />" class="delete-user-link">
...
<c:otherwise>
	<h2 class="page-section-heading2 text-center text-uppercase text-secondary mb-0 mt-4">no clients found !!</h2>
</c:otherwise>
</c:choose>
